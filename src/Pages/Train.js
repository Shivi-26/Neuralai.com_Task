...
export default function Train(){
    return(
        <>
          ...
          <div className="col-9">
          <h1 className="text-dark-blue mt-5">Heyyy,What's up guys</h1>
          <h3 className="text-primary mt-2">We are here to give u an awesome training, <br/> Do u want to become the part of our industry</h3>
